...
var x__20636__auto__ = (((x == null))?null:x);
var m__20637__auto__ = (sablono.util.to_str[goog.typeOf(x__20636__auto__)]);
if(!((m__20637__auto__ == null))){
return (m__20637__auto__.cljs$core$IFn$_invoke$arity$1 ? m__20637__auto__.cljs$core$IFn$_invoke$arity$1(x) : m__20637__auto__.call(null,x));
} else {
var m__20637__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__20637__auto____$1 == null))){
return (m__20637__auto____$1.cljs$core$IFn$_invoke$arity$1 ? m__20637__auto____$1.cljs$core$IFn$_invoke$arity$1(x) : m__20637__auto____$1.call(null,x));
} else {
...
var x__20636__auto__ = (((x == null))?null:x);
var m__20637__auto__ = (sablono.util.to_uri[goog.typeOf(x__20636__auto__)]);
if(!((m__20637__auto__ == null))){
return (m__20637__auto__.cljs$core$IFn$_invoke$arity$1 ? m__20637__auto__.cljs$core$IFn$_invoke$arity$1(x) : m__20637__auto__.call(null,x));
} else {
var m__20637__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__20637__auto____$1 == null))){
return (m__20637__auto____$1.cljs$core$IFn$_invoke$arity$1 ? m__20637__auto____$1.cljs$core$IFn$_invoke$arity$1(x) : m__20637__auto____$1.call(null,x));
} else {
...
var len__21048__auto___48197 = arguments.length;
var i__21049__auto___48198 = (0);
while(true){
if((i__21049__auto___48198 < len__21048__auto___48197)){
args__21055__auto__.push((arguments[i__21049__auto___48198]));

var G__48199 = (i__21049__auto___48198 + (1));
i__21049__auto___48198 = G__48199;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__21056__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq48196){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq48196));
});
...
var vec__48203 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(cljs.core.name(k),/-/);
var seq__48204 = cljs.core.seq(vec__48203);
var first__48205 = cljs.core.first(seq__48204);
var seq__48204__$1 = cljs.core.next(seq__48204);
var first_word = first__48205;
var words = seq__48204__$1;
...
var G__48207 = clojure.set.rename_keys(m,kmap);
if(cljs.core.map_QMARK_(cljs.core.cst$kw$style.cljs$core$IFn$_invoke$arity$1(m))){
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__48207,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$style], null),sablono$util$camel_case_keys);
} else {
return G__48207;
}
} else {
...
return clojure.string.join.cljs$core$IFn$_invoke$arity$2(" ",cljs.core.flatten(cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__48208_SHARP_){
if(typeof p1__48208_SHARP_ === 'string'){
return p1__48208_SHARP_;
} else {
return cljs.core.seq(p1__48208_SHARP_);
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__19973__auto__ = x__$1.hasDomain();

...
if(((cljs.core.set_QMARK_(class$__$1)) || (cljs.core.sequential_QMARK_(class$__$1))) && (cljs.core.every_QMARK_((function (p1__48280_SHARP_){
return ((p1__48280_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__48280_SHARP_ === 'string');
}),class$__$1))){
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(G__48282,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$class], null),sablono.normalize.class$);
} else {
return G__48282;
}
});
...
var len__21048__auto___48285 = arguments.length;
var i__21049__auto___48286 = (0);
while(true){
if((i__21049__auto___48286 < len__21048__auto___48285)){
args__21055__auto__.push((arguments[i__21049__auto___48286]));

var G__48287 = (i__21049__auto___48286 + (1));
i__21049__auto___48286 = G__48287;
continue;
} else {
}
break;
...
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(argseq__21056__auto__);
});
...
var G__48284 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.merge,maps__$1);
if(!(cljs.core.empty_QMARK_(classes__$1))){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__48284,cljs.core.cst$kw$class,classes__$1);
} else {
return G__48284;
}
});
...
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq48283){
return sablono.normalize.merge_with_class.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq48283));
});
...
var vec__48293 = ((cljs.core.empty_QMARK_(matches))?(function(){throw cljs.core.ex_info.cljs$core$IFn$_invoke$arity$2([cljs.core.str("Can't match CSS tag: "),cljs.core.str(s)].join(''),new cljs.core.PersistentArrayMap(null, 1, [cljs.core.cst$kw$tag,s], null))})():(cljs.core.truth_(new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, ["#",null,".",null], null), null).call(null,cljs.core.ffirst(matches)))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, ["div",matches], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(matches),cljs.core.rest(matches)], null)
));
var tag_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48293,(0),null);
var names = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48293,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,cljs.core.first(cljs.core.map.cljs$core$IFn$_invoke$arity$2(sablono.normalize.strip_css,cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (matches,vec__48293,tag_name,names){
return (function (p1__48288_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("#",cljs.core.first(p1__48288_SHARP_));
});})(matches,vec__48293,tag_name,names))
,names))),cljs.core.vec(cljs.core.map.cljs$core$IFn$_invoke$arity$2(sablono.normalize.strip_css,cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (matches,vec__48293,tag_name,names){
return (function (p1__48289_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(".",cljs.core.first(p1__48289_SHARP_));
});})(matches,vec__48293,tag_name,names))
,names)))], null);
});
/**
...
return cljs.core.remove.cljs$core$IFn$_invoke$arity$2(cljs.core.nil_QMARK_,((typeof x === 'string')?(function (){var x__20807__auto__ = x;
return cljs.core._conj(cljs.core.List.EMPTY,x__20807__auto__);
})():(cljs.core.truth_(sablono.util.element_QMARK_(x))?(function (){var x__20807__auto__ = x;
return cljs.core._conj(cljs.core.List.EMPTY,x__20807__auto__);
})():(((cljs.core.list_QMARK_(x)) && ((x instanceof cljs.core.Symbol)))?(function (){var x__20807__auto__ = x;
return cljs.core._conj(cljs.core.List.EMPTY,x__20807__auto__);
})():((cljs.core.list_QMARK_(x))?x:(((cljs.core.sequential_QMARK_(x)) && (cljs.core.sequential_QMARK_(cljs.core.first(x))) && (!(typeof cljs.core.first(x) === 'string')) && (cljs.core.not(sablono.util.element_QMARK_(cljs.core.first(x)))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.count(x),(1))))?sablono$normalize$children(cljs.core.first(x)):((cljs.core.sequential_QMARK_(x))?x:(function (){var x__20807__auto__ = x;
return cljs.core._conj(cljs.core.List.EMPTY,x__20807__auto__);
})()
)))))));
});
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__48297){
var vec__48304 = p__48297;
...
var tag = first__48306;
var content = seq__48305__$1;
...
var vec__48307 = sablono.normalize.match_tag(tag);
var tag__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48307,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48307,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__48307,(2),null);
